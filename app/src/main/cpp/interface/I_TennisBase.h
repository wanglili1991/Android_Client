...
#if FALSE
 #define TENNIS_STDCALL __attribute__( ( __stdcall__ ) )
#else
...
enum PlayModel
{
    ...
    PLAYMODEL_DRILL_BILATERAL         = 21,  // 双边练
...
struct InitParam
{
    ...
    // For 双边练
    PlayModel playModelOther;     // 打球模式
    CourtArea servePositionOther; // 发球位置或被训练的人所在位置
};
