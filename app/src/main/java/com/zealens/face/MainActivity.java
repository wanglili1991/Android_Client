...
public class MainActivity extends AppCompatActivity implements BoutCallback, DrillCallback {
    ...
    void setInitParam() {
        ...
        mInitParam.appPath = "/home/zealens/projects/bin/";
        mInitParam.cfgPath = "/home/zealens/projects/bin/config/";
        mInitParam.tmpPath = "/home/zealens/projects/bin/data/";
    }
                ...
                switch (msg.what) {
                    case MSG_RUN_ENGINE: {
                        ...
                        if ((mPlayModel & TennisBase.PlayModel.PLAYMODEL_MASK) == TennisBase.PlayModel.MATCH_SINGLE) {
                            ...
                            if (!mTennisBout.init(mInitParam, MainActivity.this))
                                return;
                            ...
                            if (!mTennisDrill.init(mInitParam, MainActivity.this, TennisBase.DrillDifficulty.EASY))
                                return;
                    ...
                    case MSG_NEXT_DRILLL: {
                        Log.e(TAG, "mIndexCase = " + mIndexCase);
                        if (++mIndexCase == 128)
                            break;
//                        IniFile file = new IniFile(new File(mInitParam.cfgPath + "/config.cfg"));
//                        file.set("mixed", "event_id", getTennisDrillEventID());
//                        file.save();
                        mTennisDrill.restart(TennisBase.CourtArea.A1);
