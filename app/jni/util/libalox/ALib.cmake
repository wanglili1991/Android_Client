...
# --------------------------------------------------------------------------------------------------
    ...
    set( temp "${CMAKE_CURRENT_SOURCE_DIR}/src/main/cpp/util" )
    ...
    set( ALIB_DEBUG_STRINGS             ${tmp_default_val}                              CACHE   BOOL
...
# --------------------------------------------------------------------------------------------------
    ...
    # check
    if (NOT EXISTS "${ALIB_BASE_DIR}/alox/" )
...
# --------------------------------------------------------------------------------------------------
    ...
    set (              ALIB_SRC_DIR      ${ALIB_BASE_DIR}/alox              )
    file( GLOB_RECURSE ALIB_INCS         ${ALIB_BASE_DIR}/alox/alib/*.h*    )
    file( GLOB_RECURSE ALIB_SRCS         ${ALIB_BASE_DIR}/alox/alib/*.cpp   )

    if ( ${APPLE} )
        file( GLOB_RECURSE ALIB_SRCS     ${ALIB_SRCS}    ${ALIB_BASE_DIR}/alox/alib/*.mm   )
    endif()
